...
{
    /// <summary>
    /// Rail (DC) model generated from CircuitJS1 reference file RailElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/RailElm.java for full behavioral parity.
    /// </summary>
    public class RailDcComponent : ElectricalComponentBase
    {
...
[SerializeField] private float sourceVoltageVolts = 5f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.RailDc;
