...
{
    /// <summary>
    /// Timer (555) model generated from CircuitJS1 reference file TimerElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/TimerElm.java for full behavioral parity.
    /// </summary>
    public class Timer555Component : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Timer555;
