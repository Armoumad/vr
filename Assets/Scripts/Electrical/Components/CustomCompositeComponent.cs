...
{
    /// <summary>
    /// Custom Composite model generated from CircuitJS1 reference file CustomCompositeElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/CustomCompositeElm.java for full behavioral parity.
    /// </summary>
    public class CustomCompositeComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputImpedanceOhms = 1000f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.CustomComposite;
