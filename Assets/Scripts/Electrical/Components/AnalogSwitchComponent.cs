...
{
    /// <summary>
    /// Analog Switch model generated from CircuitJS1 reference file AnalogSwitchElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/AnalogSwitchElm.java for full behavioral parity.
    /// </summary>
    public class AnalogSwitchComponent : ElectricalComponentBase
    {
...
[SerializeField] private bool state;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.AnalogSwitch;
