...
{
    /// <summary>
    /// DPDT Switch model generated from CircuitJS1 reference file DPDTSwitchElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/DPDTSwitchElm.java for full behavioral parity.
    /// </summary>
    public class DpdtSwitchComponent : ElectricalComponentBase
    {
...
[SerializeField] private bool state;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.DpdtSwitch;
