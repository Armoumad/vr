...
{
    /// <summary>
    /// Delay Buffer model generated from CircuitJS1 reference file DelayBufferElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/DelayBufferElm.java for full behavioral parity.
    /// </summary>
    public class DelayBufferComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.DelayBuffer;
