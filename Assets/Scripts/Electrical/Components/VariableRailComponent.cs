...
{
    /// <summary>
    /// Variable Rail model generated from CircuitJS1 reference file VarRailElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/VarRailElm.java for full behavioral parity.
    /// </summary>
    public class VariableRailComponent : ElectricalComponentBase
    {
...
[SerializeField] private float sourceVoltageVolts = 5f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.VariableRail;
