...
{
    /// <summary>
    /// SRAM model generated from CircuitJS1 reference file SRAMElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/SRAMElm.java for full behavioral parity.
    /// </summary>
    public class SramComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Sram;

        public override int TerminalCount => 10;
