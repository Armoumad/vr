...
{
    /// <summary>
    /// Data Input model generated from CircuitJS1 reference file DataInputElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/DataInputElm.java for full behavioral parity.
    /// </summary>
    public class DataInputComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputImpedanceOhms = 1000f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.DataInput;
