...
{
    /// <summary>
    /// JK Flip-Flop model generated from CircuitJS1 reference file JKFlipFlopElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/JKFlipFlopElm.java for full behavioral parity.
    /// </summary>
    public class JkFlipFlopComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.JkFlipFlop;

        public override int TerminalCount => 7;
