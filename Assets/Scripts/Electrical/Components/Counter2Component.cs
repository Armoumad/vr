...
{
    /// <summary>
    /// Counter 2 model generated from CircuitJS1 reference file Counter2Elm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/Counter2Elm.java for full behavioral parity.
    /// </summary>
    public class Counter2Component : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Counter2;
