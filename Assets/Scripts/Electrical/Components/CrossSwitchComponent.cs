...
{
    /// <summary>
    /// Cross Switch model generated from CircuitJS1 reference file CrossSwitchElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/CrossSwitchElm.java for full behavioral parity.
    /// </summary>
    public class CrossSwitchComponent : ElectricalComponentBase
    {
...
[SerializeField] private bool state;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.CrossSwitch;
