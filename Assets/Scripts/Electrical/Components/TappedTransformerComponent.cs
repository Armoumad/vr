...
{
    /// <summary>
    /// Tapped Transformer model generated from CircuitJS1 reference file TappedTransformerElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/TappedTransformerElm.java for full behavioral parity.
    /// </summary>
    public class TappedTransformerComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputImpedanceOhms = 1000f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.TappedTransformer;

        public override int TerminalCount => 5;
