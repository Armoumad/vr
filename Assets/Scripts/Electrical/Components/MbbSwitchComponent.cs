...
{
    /// <summary>
    /// MBB Switch model generated from CircuitJS1 reference file MBBSwitchElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/MBBSwitchElm.java for full behavioral parity.
    /// </summary>
    public class MbbSwitchComponent : ElectricalComponentBase
    {
...
[SerializeField] private bool state;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.MbbSwitch;
