...
{
    /// <summary>
    /// Logic Input model generated from CircuitJS1 reference file LogicInputElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/LogicInputElm.java for full behavioral parity.
    /// </summary>
    public class LogicInputComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.LogicInput;
