...
{
    /// <summary>
    /// Clock model generated from CircuitJS1 reference file ClockElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/ClockElm.java for full behavioral parity.
    /// </summary>
    public class ClockComponent : ElectricalComponentBase
    {
...
[SerializeField] private float sourceVoltageVolts = 5f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Clock;
