...
{
    /// <summary>
    /// CCCS model generated from CircuitJS1 reference file CCCSElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/CCCSElm.java for full behavioral parity.
    /// </summary>
    public class CccsComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputImpedanceOhms = 1000f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Cccs;
