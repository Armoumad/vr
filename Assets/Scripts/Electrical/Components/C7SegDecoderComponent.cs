...
{
    /// <summary>
    /// 7-Seg Decoder model generated from CircuitJS1 reference file SevenSegDecoderElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/SevenSegDecoderElm.java for full behavioral parity.
    /// </summary>
    public class C7SegDecoderComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        [Tooltip("Terminal index 8")]
        [SerializeField] private int terminal8 = 8;

        [Tooltip("Terminal index 9")]
        [SerializeField] private int terminal9 = 9;

        [Tooltip("Terminal index 10")]
        [SerializeField] private int terminal10 = 10;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.C7SegDecoder;

        public override int TerminalCount => 11;
