...
{
    /// <summary>
    /// ADC model generated from CircuitJS1 reference file ADCElm.java.
    /// Simplified for Unity breadboard integration with stable stamping/step behavior.
    /// TODO(parity): compare against https://github.com/pfalstad/circuitjs1/blob/master/src/com/lushprojects/circuitjs1/client/ADCElm.java for full behavioral parity.
    /// </summary>
    public class AdcComponent : ElectricalComponentBase
    {
...
[SerializeField] private float outputLowVoltage = 0f;
        ...
        public override ElectricalComponentKind Kind => ElectricalComponentKind.Adc;
